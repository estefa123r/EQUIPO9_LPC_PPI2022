...
-- Tiempo de generación: 16-11-2022 a las 23:51:46
...
--
-- Base de datos: `epiz_33009309_biblioteca`
--
...
(6, 'ciencia ficcion ecuatoriona', 'Isaac Asimov', 'Ciencia Ficion', 'empieza con una breve discusión sobre la obra de carácter político-utópico del padre Vicente Solano, pasando luego por los cuentos de Juan León Mera y de Juan Montalvo, entre otros.', '1668352710_ciencia de ficcion ecuatoriana.png', 2018, ' El Fakir', 5000),
(7, 'el nombre del viento', 'Patrick Rothfuss', 'Literatura Fantastica', 'La novela cuenta la historia de Kvothe, un personaje legendario que, tras años de retiro, accede a contar a un cronista los verdaderos motivos por los que se convirtió en leyenda. ', '1668353117_el nombre del viento.png', 2007, 'Plaza & Janés', 5000),
(8, 'la tercera vida despues de la vida', 'Raymond A. Moody', 'Ciencia Ficion', 'una serie de relatos de personas que superaron la muerte clínica, y que, durante un tiempo estuvieron técnicamente muertas para los médicos, y que luego volvieron a la vida.', '1668353616_la tercera vida despues de la vida.png', 1975, 'Edaf, S.L', 5000),
...
(11, 'the arrival', 'Ted Chiang', 'Ciencia Ficion', 'El libro se trata de una llegada, sí, y en muchos sentidos a un nuevo mundo, a una nueva vida, a una nueva versión de vos mismo; es también una llegada al conocimiento y a una identidad que se renueva y se afirma en lo que ya era, todo en una única pincelada, que nos lleva inevitablemente a un final, sencillo pero...', '1668355668_the arrival.png', 1998, 'Arthur A. Levine Books', 5000),
(12, 'la maquina del tiempo ', ' William Heinemann', 'Ciencia', 'Un científico inventa una máquina para viajar a través del tiempo. En un viaje experimental llega al año 802.701 y encuentra la tierra habitada por los Eloi, pacíficos y ociosos. El Viajero del Tiempo deduce que están tan avanzados que unas máquinas deben de trabajar por ellos.', '1668356086_la maquina del tiempo.png', 1895, ' Heinemann', 5000),
(13, 'la ciudad y la ciudad', 'china Mieville', 'Literatura Fantastica', 'investiga el asesinato de Mahalia Geary, una estudiante extranjera que apareció muerta y con la cara desfigurada en una calle de Besźel.', '1668356285_la ciudad y la ciudad.png', 2009, 'La Factoría de Ideas', 5000),
(14, 'cronicas marciales ', 'Ray Bradbury', 'Ciencia Ficion', 'es un conjunto de relatos que narra de modo fragmentario diversos episodios relacionados con la conquista y colonización de Marte por los habitantes del planeta Tierra y las diferentes reacciones de los marcianos ante ellos. ', '1668356544_cronicas marciales.png', 1950, 'minotauro', 5000),
(15, 'un mundo inmortal', 'Jorge Luis Borges', 'Alta Fantasia', 'relata que, huyendo de unos sediciosos, Rufo se pierde en el desierto y se encuentra con un jinete moribundo que buscaba “el río secreto que purifica de la muerte a los hombres”. Tras la muerte del jinete, el soldado decide buscar esas aguas que dan la inmortalidad.', '1668356788_un mundo inmortal.png', 1947, 'españa', 5000),
(16, 'hacia las estrellas ', 'Álex Riveiro.', 'Alta Fantasia', 'plantea una ucronía en la que un meteorito arrasa Washington D. C. en 1952, años antes de la fundación de la NASA, que quedará borrada de la historia. La catástrofe es inmediata, y su efecto a largo plazo podría ser la extinción de la vida en la Tierra en cuestión de décadas.', '1668356948_hacia las extrellas.png', 2019, 'españa', 5000),
(17, 'A traves de mi ventana ', 'Ariana Godoy', 'Alta Fantasia', 'Raquel siempre ha estado enamorada de su atractivo y misterioso vecino, Ares. Todos los días ella lo espía por la ventana, pues, aunque desea hablar con él, esto nunca ha sido posible; sin embargo, las circunstancias están a punto de cambiar.', '1668357484_a traves de mi ventana.png', 2019, 'Veronica callon', 5000),
(18, 'Alicia paisa de las maravillas ', 'Lewis Carroll', 'Novela', 'cuenta cómo una niña llamada Alicia cae por un agujero, encontrándose en un mundo peculiar y extraño, poblado por humanos y criaturas antropomórficas. El libro juega con la lógica, dando a la novela gran popularidad tanto en niños como en adultos.', '1668358105_alicia en el pais de las maravillas.png', 1865, 'Macmillan Publishers', 5000),
(20, 'A Teaspoon of Earth and Sea', 'Dina Nayeri', 'Alta Fantasia', 'es una novela mágica sobre una mujer joven iraní levanta el duelo por su poderosa imaginación y amor por la cultura occidental.', '1668358445_a teaspoon earth and sea.png', 2013, 'Blackstone Audio, Inc.', 5000),
(21, 'Almendra ', 'Won-pyung sohn', 'Ciencia Ficion', 'es una historia sobre crecer, descubrirse a uno mismo y aceptar que la ayuda no siempre viene por donde la esperamos. Yunjae tiene dieciséis años, está en la edad de las emociones desbordadas, el amor y la rabia.', '1668358817_almendra.png', 2017, 'temas de hoy ', 5000),
(22, 'Asuntos de horno', 'José de la Cuadra', 'Infantin', 'desde sus costumbres y los abusos de los que son víctimas, hasta sus deseos, sus temores y sus sueños frustrados.', '1668359047_Asuntos de horno.png', 1932, 'Talleres de la Sociedad Filantrópica de Guayaquil.', 5000),
(23, 'Dracula ', ' Bram Stoker', 'Terror', 'El joven abogado británico Jonathan Harker viaja a Transilvania para negociar en nombre de un bufete de abogados de Londres con un conde que está interesado en adquirir una propiedad en Inglaterra.', '1668360148_dracula.png', 1897, 'miguel angel ', 5000),
(24, 'Atlantis proytecto', 'Mateos Carreira', 'Aventura', 'pretende facilitar al docente la aplicación en el aula de los contenidos y las dinámicas que se desarrollan en los manuales', '1668360333_atlantis proyecto tarsis.png', 2015, 'miguel angel', 5000),
(25, 'atrapados ', 'Oliver Jeffers', 'Comedia', 'Todo empieza cuando la cometa de Floyd queda atrapada en un árbol. Floyd prueba de tirar y sacudirla, pero no hay manera de que se desenganche. Entonces decide lanzar su zapato preferido para hacerla caer, pero también se queda atrapado.', '1668360454_atrapados.png', 2012, 'FONDO DE CULTURA ECONÓMICA (FCE)', 5000),
(26, 'cada historia cuenta ', 'Paola herrera', 'Novela', 'trata de un libro solidario donde parte de los beneficios obtenidos por su venta irán destinados a la Fundación AINDACE, cuya misión fundamental es ayudar a personas con daño cerebral a través de la financiación de proyectos de investigación.', '1668360723_cada historia cuenta.png', 2020, 'Kurere', 5000),
(27, 'calvino ', 'Italo calvino', 'Novela', 'Las ciudades invisibles se presentan como una serie de relatos de viaje que Marco Polo hace a Kublai Kan, emperador de los tártaros... A este emperador melancólico que ha comprendido que su ilimitado poder poco cuenta en un mundo que marcha hacia la ruina, un viajero imaginario le habla de ciudades...', '1668360895_calvino.png', 1951, 'literatura reformada ', 5000),
...
(29, 'candido ', 'voltaire ', 'Novela', 'Una novela de aprendizaje sobre un optimista que cree a pies juntillas que el mundo es un paraíso, aunque la realidad se encarga de negarlo.', '1668362202_candido.png', 1759, 'UNIVERSIDAD VERACRUZANA', 5000),
(30, 'caroline y la puerta secreta ', 'Neil Gaiman', 'Alta Fantasia', 'Coraline se da cuenta de que, tras los espejos, hay otros niños que han caído en la trampa. Son como almas perdidas, y ahora ella es su única esperanza de salvación. Pero para rescatarlos tendrá también que recuperar a sus verdaderos padres, y cumplir así el desafío que le permitirá volver a su vida anterior.', '1668362400_caroline.png', 2002, 'Neil Gaiman', 5000),
...
(37, 'Las aventuras de Tom Sawyer', 'Mark Twain', 'Aventura', 'Samuel Langhorne Clemens, mÃ¡s conocido como Mark Twain, naciÃ³ en la villa de Florida, Misuri, en 1835. Cuando tenÃ­a cuatro aÃ±os de edad, se trasladÃ³ con su familia a la localidad de Hannibal, a orillas del Misisipi. A los doce aÃ±os, empezÃ³ a trabajar como aprendiz en el periÃ³dico local', '1668618468_Tom las aventuras Sawger.png', 2014, 'Anaya Infantil Y Juvenil', 5000);
...
(12, 37, 'prueba rodriguez', 2147483647, '3043500375'),
(13, 10, 'estefania', 112123146, '3245871142');
